...
int cardEffectSmithy(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer){
  //+3 Cards
      for (int i = 0; i < 3; i++)
  {
...
int cardEffectMine(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer){
...
int cardEffectVillage(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer){
//+1 Card
      drawCard(currentPlayer, state);
...
int cardEffectBaron(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case village:
      ...
      return cardEffectVillage(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
  ...
  temphand[i] = -1;
    ...
    case mine:
      ...
      return cardEffectMine(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
  {
    ...
    case smithy:
      ...
      return cardEffectSmithy(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);

    case baron:

      return cardEffectBaron(card, choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
